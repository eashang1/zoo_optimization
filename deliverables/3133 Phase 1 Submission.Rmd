...
\begin{aligned}
  ...
  r_{i} &= \textrm{pounds of food required per day by animal } i \\
\end{aligned}
$$  
...
\begin{aligned}
  ...
  & 200000 + 10(\sum_{k=1}^{9} \frac{3q_{k}}{10000} ) \geq 1.05(100000 + \sum_{k=1}^{9}a_{k} + \sum_{i=1}^{20} \sum_{j=1}^{3}\frac{90x_{ij}{c_{ij}}}{10}) \\
